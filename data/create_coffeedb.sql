...
-- Créez la table avec les colonnes appropriées
...
-- Définit l'encodage du client en UTF-8
SET client_encoding TO 'UTF8';

-- Insérez les données dans la table coffee
INSERT INTO "coffee" ("name", "description", "reference", "origin", "price", "taste", "available") VALUES
...
('Brazilian Santos', 'Café doux et lisse avec un profil de saveur noisette.', 134009550, 'Brésil', 17.80, 'Doux', TRUE),
...
('Panamanian Geisha', 'Café rare aux arômes floraux complexes, une acidité brillante et un profil de saveur distinctif.', 795501340, 'Panama', 42.00, 'Fruité', FALSE),
